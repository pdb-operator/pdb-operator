...
const (
	...
	LabelManagedBy         = "pdboperator.io/managed-by"
	LabelWorkload          = "pdboperator.io/workload"
	LabelWorkloadFunction  = "pdboperator.io/workload-function"
	LabelAvailabilityClass = "pdboperator.io/availability-class"

	AnnotationCreatedBy    = "pdboperator.io/created-by"
	AnnotationCreationTime = "pdboperator.io/creation-time"
	AnnotationLastModified = "pdboperator.io/last-modified"
	AnnotationDescription  = "pdboperator.io/description"
	AnnotationPolicySource = "pdboperator.io/policy-source"
	AnnotationEnforcement  = "pdboperator.io/enforcement-mode"

	// Finalizers
	FinalizerPDBCleanup = "pdboperator.io/pdb-cleanup"

	// Default values
	DefaultPDBSuffix = "-pdb"
	OperatorName     = "pdb-operator"
...
type AvailabilityConfig struct {
	...
	WorkloadFunction  availabilityv1alpha1.WorkloadFunction
...
func (r *DeploymentReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	// Check if we're in a maintenance window — temporarily relax PDB
	if r.isInMaintenanceWindow(config, log.FromContext(ctx)) {
		...
		if err := r.removePDBTemporarily(ctx, deployment, log.FromContext(ctx)); err != nil {
			reconcileErr = err
...
func (r *DeploymentReconciler) getConfigFromPolicyWithCacheAndPolicy(ctx context.Context, deployment *appsv1.Deployment, logger logr.Logger) (*AvailabilityConfig, *availabilityv1alpha1.PDBPolicy, error) {
	// Try cache first
	...
	componentFunction := r.inferWorkloadFunction(deployment)
...
func (r *DeploymentReconciler) policyMatchesDeployment(policy *availabilityv1alpha1.PDBPolicy, deployment *appsv1.Deployment) bool {
	...
	if len(selector.WorkloadFunctions) > 0 {
		...
		if deployment.Annotations != nil {
			if function := deployment.Annotations[AnnotationWorkloadFunction]; function != "" {
				deploymentFunction = availabilityv1alpha1.WorkloadFunction(function)
			}
		}
...
func (r *DeploymentReconciler) inferWorkloadFunction(deployment *appsv1.Deployment) availabilityv1alpha1.WorkloadFunction {
