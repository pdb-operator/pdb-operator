...
func newTestPolicy(name, ns string) *pdbv1alpha1.PDBPolicy {
	return &pdbv1alpha1.PDBPolicy{
...
func TestPolicyCache_GetList_SetList(t *testing.T) {
	...
	cache.SetList("all", []pdbv1alpha1.PDBPolicy{p1, p2})
...
func TestPolicyCache_InvalidatePolicy(t *testing.T) {
	...
	cache.SetList("all-policies", []pdbv1alpha1.PDBPolicy{*p1, *p2})
...
func TestPolicyCache_InvalidateByNamespace(t *testing.T) {
	...
	cache.SetList("all-policies", []pdbv1alpha1.PDBPolicy{*p1, *p2, *p3})
